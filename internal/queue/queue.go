 ...
 * из своего буфера (JSON_DEADLINE_EXCEEDED), чтобы слот занял свежий запрос.
 * Полная очередь живых — drop (JSON_QUEUE_LIMIT) или wait до места / дедлайна.
...
const (
	ReasonQueueLimit       = "JSON_QUEUE_LIMIT"
	ReasonDeadlineExceeded = "JSON_DEADLINE_EXCEEDED"
