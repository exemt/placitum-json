/*
 * Поколение профилей контракта из JetStream KV.
 *
 * Манифест несёт текст profile.yaml и тексты спецификаций -- ровно те файлы,
 * что лежат в каталоге профиля. Поэтому здесь нет ни разбора профиля, ни валидации:
